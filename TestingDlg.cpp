...
CTestingDlg::CTestingDlg(CWnd* pParent /*=nullptr*/)
...
BEGIN_MESSAGE_MAP(CTestingDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CTestingDlg::OnBnClickedButton1)
END_MESSAGE_MAP()
...
void CTestingDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
